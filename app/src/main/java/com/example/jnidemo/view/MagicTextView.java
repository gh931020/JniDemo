...
public class MagicTextView extends TextView {
    ...
    public void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            String typefaceName = a.getString(R.styleable.MagicTextView_mtvTypeface);
            if (typefaceName != null) {
                Typeface tf = Typeface.createFromAsset(getContext().getAssets(), String.format("fonts/%s.ttf", typefaceName));
                setTypeface(tf);
            }

            if (a.hasValue(R.styleable.MagicTextView_mtvForeground)) {
                Drawable foreground = a.getDrawable(R.styleable.MagicTextView_mtvForeground);
                if (foreground != null) {
                    this.setForegroundDrawable(foreground);
                }
                else {
                    this.setTextColor(a.getColor(R.styleable.MagicTextView_mtvForeground, 0xff000000));
                }
            }

            if (a.hasValue(R.styleable.MagicTextView_mtvBackground)) {
                Drawable background = a.getDrawable(R.styleable.MagicTextView_mtvBackground);
                if (background != null) {
                    this.setBackgroundDrawable(background);
                }
                else {
                    this.setBackgroundColor(a.getColor(R.styleable.MagicTextView_mtvBackground, 0xff000000));
                }
            }

            if (a.hasValue(R.styleable.MagicTextView_mtvInnerShadowColor)) {
                this.addInnerShadow(a.getDimensionPixelSize(R.styleable.MagicTextView_mtvInnerShadowRadius, 0),
                        a.getDimensionPixelOffset(R.styleable.MagicTextView_mtvInnerShadowDx, 0),
                        a.getDimensionPixelOffset(R.styleable.MagicTextView_mtvInnerShadowDy, 0),
                        a.getColor(R.styleable.MagicTextView_mtvInnerShadowColor, 0xff000000));
            }

            if (a.hasValue(R.styleable.MagicTextView_mtvOuterShadowColor)) {
                this.addOuterShadow(a.getDimensionPixelSize(R.styleable.MagicTextView_mtvOuterShadowRadius, 0),
                        a.getDimensionPixelOffset(R.styleable.MagicTextView_mtvOuterShadowDx, 0),
                        a.getDimensionPixelOffset(R.styleable.MagicTextView_mtvOuterShadowDy, 0),
                        a.getColor(R.styleable.MagicTextView_mtvOuterShadowColor, 0xff000000));
            }

            if (a.hasValue(R.styleable.MagicTextView_mtvStrokeColor)) {
                float strokeWidth = a.getDimensionPixelSize(R.styleable.MagicTextView_mtvStrokeWidth, 1);
                int strokeColor = a.getColor(R.styleable.MagicTextView_mtvStrokeColor, 0xff000000);
                float strokeMiter = a.getDimensionPixelSize(R.styleable.MagicTextView_mtvStrokeMiter, 10);
                Join strokeJoin = null;
                switch (a.getInt(R.styleable.MagicTextView_mtvStrokeJoinStyle, 0)) {
                    case (0):
